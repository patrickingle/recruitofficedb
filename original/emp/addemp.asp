...
<title>RecruitOffice DB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -YestoNet</title>
<style><!--
...
if (theForm.client_id.value.length > 0)
  {
    alert("Please select a value for the Client ID field.");
    theForm.client_id.focus();
    return (false);
  }
...
<blockquote>
 ...
 <select size="1" name="tot_max_exp">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; H1 Status: <select size="1" name="h1_status">
          ...
          <p>&nbsp;&nbsp;&nbsp; <font color="#FF0000">Social Security:</font> <input type="text" name="social_security" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

...
vSearchStr= "SELECT * FROM security WHERE session_id= '" + CStr(Session.SessionID) + "'"	
	rsCan.Open vSearchStr, cn, adOpenStatic, adLockOptimistic
...
ElseIf rsCan.Fields("privilege").Value = "read_only" then
	rsCan.close
	cn.close
	Set rsCan=Nothing
	Set cn=Nothing
	Response.Redirect("../noprivilege.html")
ElseIf Request.QueryString.count < 1 or Request.QueryString("can_id") = "" then
	rsCan.Fields("session_id").Value = "0"
	rsCan.update
	rsCan.close
	cn.close
	Set rsCan=Nothing
...
vSearchStr="select * from candidates where can_id =" + Request.QueryString("can_id")
rsCan.Open vSearchStr, cn, adOpenStatic, adLockOptimistic
...
<blockquote>
      ...
      <blockquote>
        ...
        <form method="POST" action="addcans.asp" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1">
          <input type="HIDDEN" name="choice" Value="update" >
			<input type="HIDDEN" name="can_id" Value="<%=Request.QueryString("can_id") %>" >
          <p align="left"><font color="#FF9933"><u>**********<font face="Comic Sans MS">General
          Information:-</font></u></font></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#FF0000">First Name:</font> <input type="text" name="f_name" Value="<% =rsCan.Fields("f_name").value %>"  size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">
          Last Name:</font> <input type="text" name="l_name" Value="<% =rsCan.Fields("l_name").value %>" size="20"></p>
          <p>Present Address: <input type="text" name="present_address" Value="<% =rsCan.Fields("present_address").value %>" size="20">&nbsp;&nbsp;&nbsp;&nbsp;
          <font color="#FF0000">Permanent Address:</font> <input type="text" name="perma_address" Value="<% =rsCan.Fields("perma_address").value %>" size="20"></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <font color="#FF0000">City: </font> <input type="text" name="city" Value="<% =rsCan.Fields("city").value %>" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <font color="#FF0000">State/Province:</font> <input type="text" name="state_province" Value="<% =rsCan.Fields("state_province").value %>" size="20"></p>
          ...
          </select>Old: <% =rsCan.Fields("country").value %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">
          Zip
          Code: </font><input type="text" name="zip_code" Value="<% =rsCan.Fields("zip_code").value %>" size="20">
          </p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <font color="#000000">Email: </font><input type="text" name="email" Value="<% =rsCan.Fields("email").value %>" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <font color="#000000">Phone: </font> <input type="text" name="phone" Value="<% =rsCan.Fields("phone").value %>" size="20"></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          Fax: <input type="text" name="fax" Value="<% =rsCan.Fields("fax").value %>" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          Sex: <select size="1" name="sex">
          <option>F</option>
          <option selected>M</option>
        </select>Old: <% =rsCan.Fields("sex").value %>&nbsp;Married:
        <select size="1" name="married">
          <option>Y</option>
          <option selected>N</option>
        </select>Old: <% =rsCan.Fields("married").value %></p>
          <p><font color="#FF0000">Max. Basic Education: </font> <input type="text" name="max_edu" Value="<% =rsCan.Fields("max_edu").value %>" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">
          Institute: </font> <input type="text" name="max_institute" Value="<% =rsCan.Fields("max_institute").value %>" size="20"></p>
          <p align="left">&nbsp;</p>
          <p align="left"><u><font face="Comic Sans MS" color="#FF9933">**********Computer
          Skills:-</font></u></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;
          OS1: <input type="text" name="os1" Value="<% =rsCan.Fields("os1").value %>" size="14">&nbsp;&nbsp;&nbsp;&nbsp;
          OS2: <input type="text" name="os2" Value="<% =rsCan.Fields("os2").value %>" size="14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          OS3: <input type="text" name="os3" Value="<% =rsCan.Fields("os3").value %>" size="14"></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Language1: <input type="text" name="lang1" Value="<% =rsCan.Fields("lang1").value %>" size="14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          Language2: <input type="text" name="lang2" Value="<% =rsCan.Fields("lang2").value %>" size="14"></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Language3: <input type="text" name="lang3" Value="<% =rsCan.Fields("lang3").value %>" size="14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">
 </font> 
 ...
 <select size="1" name="tot_max_exp">
            ...
            <option>39</option>
            <option>40</option>
      </select> </font> Old: <% =rsCan.Fields("tot_max_exp").value %></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Other Skills:&nbsp;</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="3" name="other_skills" cols="52"><% =rsCan.Fields("other_skills").value %></textarea></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp; Certifications:&nbsp;</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="2" name="certs" cols="53"><% =rsCan.Fields("certs").value %></textarea></p>
          <p align="left">&nbsp;</p>
          <p align="left"><u><font face="Comic Sans MS" color="#FF9933">**********Project
          Details:-</font></u></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Project 1:</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="2" name="project1" cols="53"><% =rsCan.Fields("project1").value %></textarea></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Project 2:</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="2" name="project2" cols="53"><% =rsCan.Fields("project2").value %></textarea></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Project 3:</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="2" name="project3" cols="53"><% =rsCan.Fields("project3").value %></textarea></p>
          <p>Other Projects:</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <textarea rows="2" name="other_projects" cols="53"><% =rsCan.Fields("other_projects").value %></textarea></p>
        <p>&nbsp;</p>
        ...
        Status:-</font></u></p>
          ...
          </select>Old: <% =rsCan.Fields("select_status").value %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          </select>Old: <% =rsCan.Fields("h1_status").value %></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Candidate Location: <select size="1" name="can_location">
            <option>nHQ</option>
            <option>HQ</option>
          </select>Old: <% =rsCan.Fields("can_location").value %></p>
